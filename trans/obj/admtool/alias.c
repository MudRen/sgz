...
*/
    write("管理工具：Alias 系统选单\n"
          "\n"
          "    l         - 列出通用的玩家 aliases\n"
          "    L         - 列出通用的巫师 aliases\n"
          "    a [alias] - 增加通用的玩家 aliases\n"
          "    A [alias] - 增加通用的巫师 aliases\n" 
          "    r [alias] - 删除通用的玩家 aliases\n"
          "    R [alias] - 删除通用的巫师 aliases\n"
          "\n"
          "    m         - 主选单\n"
          "    q         - 退出\n"
          "    ?         - 帮助\n"
    ...
    case "R":
        ...
        if(undefinedp(alias_info[input]))
        {
            if(cmd == "r")
                ...
                printf("%s 不是一个玩家 alias。\n", input);
            else 
                //printf("%s wasn't a wizard alias.\n", input);
                printf("%s 不是一个巫师 alias。\n", input);
            return;
        }
        if(cmd == "r")
