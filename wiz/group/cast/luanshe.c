...
//      if(kill>enemy[s_type]["number"]) kill=enemy[s_type]["number"];
//    if(kill) 
//	WARAI_D->add_war_lose(id,p_side,s_type,kill);
//      enemy[s_type]["number"]=enemy[s_type]["number"]-kill;
//      if((enemy[s_type]["number"]-kill)==0)				
