...
string *Gan=({"¼×","ÒÒ","±û","¶¡","Îì","¼º","¸ý","ÐÁ","ÈÉ","¹ï"});
string *Zhi=({"×Ó","³ó","Òú","Ã®","³½","ËÈ","Îç","Î´","Éê","ÓÏ","Ðç","º¥"});
...
mixed get_gz(int y, int mon, int d, int min){
	...
	int a,b,c,flag;
	if( y==1582 && mon==10 && d > 4 && d < 15 ) return "ÎÞ´ËÈÕÆÚ¡£\n";
	if(y<0) {
		b=(100+(y+1)%100)%100;
		if(b!=0) a = 100-y-1; 
		else a = -y-1;
...
//	Gan=({"¼×","ÒÒ","±û","¶¡","Îì","¼º","¸ý","ÐÁ","ÈÉ","¹ï"});
//	Zhi=({"×Ó","³ó","Òú","Ã®","³½","ËÈ","Îç","Î´","Éê","ÓÏ","Ðç","º¥"});
...
string *solarTerm = ({
	"Ð¡º®","´óº®","Á¢´º","ÓêË®","¾ªÕÝ","´º·Ö",
	"ÇåÃ÷","¹ÈÓê","Á¢ÏÄ","Ð¡Âú","Ã¢ÖÖ","ÏÄÖÁ",
	"Ð¡Êî","´óÊî","Á¢Çï","´¦Êî","°×Â¶","Çï·Ö",
	"º®Â¶","Ëª½µ","Á¢¶¬","Ð¡Ñ©","´óÑ©","¶¬ÖÁ",
});
...
string *nStr1 = ({"ÈÕ","Ò»","¶þ","Èý","ËÄ","Îå","Áù","Æß","°Ë","¾Å","Ê®"});
string *nStr2 = ({"³õ","Ê®","Ø¥","Ø¦","¡õ"});
