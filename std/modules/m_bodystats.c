...
** from one another.
**
**      Strength:膂力       physical stature, power, brute force
**              Weakling vs. strong/powerful
**
**      Agility:身法        body control, speed, flexibility
**              Uncoordinated vs. excellent control
**
**      Intelligence:悟性   inherent capability for learning
**              Dumb vs. smart/capable
**
**      Willpower:意志      drive, stamina
**              Unmotivated vs. driven/fanatical
**
** A good number of statistics are derived from the base statistics.
**
**      Constitution:体格   physical/mental stamina, sturdiness
**              Elf vs. dwarf
**
**      Wisdom:智慧         collected knowledge
**              Naive vs. wise
**
**      Charisma:魅力       natural attraction, leadership, persuasion
